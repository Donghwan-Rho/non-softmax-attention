...
class TransformerLayer_modified(torch.nn.Module):
    ...
    def forward(self, states, attention_mask: Optional[torch.Tensor] = None):
        states, matmul_result = self.attn(self.norm1(states), attention_mask)
        states = states + self.dropout(states)
    ...
    def forward(self, input_ids, attention_mask: Optional[torch.Tensor] = None, labels: Optional[torch.Tensor] = None, **kwargs):
        ...
        if self.sparse_prediction and labels is not None:            
            ...
            if self.count < 100:
                ...
                print('Loss: {}, last_100_losses: {}'.format(masked_lm_loss.item(), last_100_loss))
            else:
                ...
                print('Loss: {}, last_100_losses: {}, best_100_losses: {}'.format(masked_lm_loss.item(), last_100_loss, self.best_loss))
